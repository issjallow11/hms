            ...
            <form @submit.prevent="editmode ? updateUser() : createUser()">
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input v-model="form.middle_name" type="text" name="middle_name" class="form-control"
                ...
                <div class="form-group">
                  ...
                  <input v-model="form.telephone_1" type="number" maxlength="7" name="telephone_1" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('telephone_1') }">
                  <has-error :form="form" field="telephone_1"></has-error>
                </div>
                <div class="form-group">
                  <label>Telephone II</label>
                  <input v-model="form.telephone_2" type="number" maxlength="7" name="telephone_2" class="form-control"
                ...
                <div class="form-group">
                  ...
                  <span class="float-right">
                    <i v-if="passwordType === 'password'" class="fas fa-eye" @click="showPassword"></i>
                    <i v-else class="fas fa-eye-slash" @click="showPassword"></i>
                  </span>
                  <input v-model="form.password" :type="passwordType" name="password" class="form-control"
                ...
                <div class="form-group">
                  ...
                  <input v-model="form.password_confirmation" :type="passwordType" name="password_confirmation"
