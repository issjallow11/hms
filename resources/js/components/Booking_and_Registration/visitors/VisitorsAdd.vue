          ...
          <form @submit.prevent="addVisit">
              ...
              <div class="container">
                ...
                <!-- <div>
                  ...
                  <select name="" id="" multiple class="form-control">
                    <option value="">Enquiry on services offered</option>
                ...
                <div class="form-row">
                  ...
                  <div class="col-lg-2">
                    ...
                    <input type="checkbox" name="Pregnancy Test" value="Pregnancy Test"
                      v-model="form.reason_for_visiting" />
                  </div>
                  <div class="col-lg-2">
            ...
            <div class="card-footer">
              <button type="submit" class="btn btn-primary ">
                <i class="fa fa-paper-plane text-white">submit</i>
              </button>
