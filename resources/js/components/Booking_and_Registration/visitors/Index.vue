                ...
                <tbody>
                  <tr v-for="visit in visits.data" :key="visit.id">
                    ...
                    <td>
                      ...
                      <span v-if="visit.status == 'Did not attend appointment (DNA)'" class="badge" id="DNA">{{
                          visit.status
                      }}</span>
                    </td>
                    ...
                    <td>
                      <button type="button" data-toggle="modal" @click="setVisitorId(visit.id, visit.clinic_no)"
                        data-target="#clinicalModal">
                        <router-link to="#">
                    ...
                    <td>
                      ...
                      /
                      <a v-if="$gate.isAdmin()" href="#" @click="deleteClient(visit.id)">
      ...
      <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="addNew" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <form @submit.prevent="editmode ? updateVisit() : createVisit()">
              <div class="modal-body">
                <div class="form-group">
                  <label for="">Client ID</label>
                  <input v-model="form.client_id" type="text" disabled name="description" class="form-control"
              ...
              <div class="modal-footer">
                ...
                <button v-show="!editmode" type="submit" class="btn btn-primary float-right">
                  Create
                </button>
              </div>
            </form>
            ...
            <div class="modal-body">
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-md-3 col-sm-3">
                    <router-link
                      :to="{ name: 'sexualHealthScreening', params: { visitId: visitorId, clientId: clientId } }">
                      <button class="btn btn-success p-2" data-dismiss="modal">
                  ...
                  <div class="col-md-3 col-sm-3">
                    <router-link
                      :to="{ name: 'ultraSoundScanning', params: { visitId: visitorId, clientId: clientId } }">
                      <button class="btn btn-success p-2" data-dismiss="modal">
                        Ultrasound Scanning
                      </button>
                    </router-link>
                  ...
                  <div class="col-md-3 col-sm-3">
                    <router-link
                      :to="{ name: 'infertilityManagement', params: { visitId: visitorId, clientId: clientId } }">
                      <button class="btn btn-success p-2" data-dismiss="modal">
                  ...
                  <div class="col-md-3 col-sm-3">
                    <router-link
                      :to="{ name: 'cervicalScreening', params: { visitId: visitorId, clientId: clientId } }">
                      <button class="btn btn-success p-2" data-dismiss="modal">
                        Cervical Screening
                      </button>
                    </router-link>
                  ...
                  <div class="col-md-3 col-sm-3">
                    <router-link
                      :to="{ name: 'resultsCommunication', params: { visitId: visitorId, clientId: clientId } }">
                      <button class="btn btn-success p-2" data-dismiss="modal">
                  ...
                  <div class="col-md-3 col-sm-3">
                    <router-link
                      :to="{ name: 'returnForTreatment', params: { visitId: visitorId, clientId: clientId } }">
                      <button class="btn btn-success p-2" data-dismiss="modal">
                  ...
                  <div class="col-md-3 col-sm-3">
                    <router-link
                      :to="{ name: 'sti_contactTracing', params: { visitId: visitorId, clientId: clientId } }">
                      <button class="btn btn-success p-2" data-dismiss="modal">
