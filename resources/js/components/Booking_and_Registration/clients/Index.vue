              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <tr v-for="client in getClients" :key="client.clinic_no">
                    ...
                    <td>
                      <router-link :to="{ name: 'clientsShow', params: { id: client.client_no } }">
                        <i class="fa fa-eye green"></i>
                      </router-link>/
                      <router-link :to="{ name: 'clientEdit', params: { id: client.client_no } }">
                        <i class="fas fa-edit blue"></i>
                      </router-link>
                      /
                      <a v-if="$gate.isAdmin()" href="#" @click="deleteClient(client.client_no)">
